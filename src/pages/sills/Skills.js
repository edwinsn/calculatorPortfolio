...
export default function Skills() {
    ...
    return (
        ...
        <div className='main flex-column centered w-90 full-screen' >
            ...
            <div id="skills" className='flex centered'>
                ...
                <div className='flex-column centered' >
                    ...
                    <input type="radio" name="same" id="frontend" className='display-none' checked={true} />
                    <label for="frontend" >
                ...
                <div className='flex-column centered'>
                    ...
                    <input type="radio" name="same" id="backend" className='display-none' checked={true} />
                    <label for="backend" >
                ...
                <div className='flex-column centered'>
                    ...
                    <input type="radio" name="same" id="design" className='display-none'  checked={true}/>
                    <label for="design" >
                ...
                <div className='flex-column centered'>
                    ...
                    <input type="radio" name="same" id="others" className='display-none' checked={true} />
                    <label for="others">
